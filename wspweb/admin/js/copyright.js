require(['jquery', 'bootstrap','pm','bootstrapvalidator','dropify','select2','ckeditor', 'datepickercn','raty', 'datatables'], function(){
    ...
    $(function(){
        ...
        $.ajax({
            url : '/Setting/Readme/Type/Edit?type=userCopyright&timestamp=' + new Date().getTime(),
            method : "get",
        ...
        //自动评价设置
        $.ajax({
            url: '/Setting/SettingAutoComment/Edit?type=copyright&timestamp=' + new Date().getTime() ,
            success: function (data) {
