/**
 * Created by z on 2016/10/28.
 */
require(['jquery', 'bootstrap','pm','bootstrapvalidator','ckeditor'], function(){
    $(function(){
        var setType =  queryString('type');
        if(setType == "hzCardEnterpApply"){
            $('#title').text('企业汇智卡须知配置');
        }
        ...
        $.ajax({
            url : '/Setting/Readme/Type/Edit?type='+setType,
            method : "get",
