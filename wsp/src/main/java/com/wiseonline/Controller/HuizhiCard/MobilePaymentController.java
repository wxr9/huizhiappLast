 ...
 */
@RestController
@RequestMapping("/BizPayment/Mobile")
public class MobilePaymentController extends BaseController {

    private static Logger logger = Logger.getLogger(MobilePaymentController.class);

    @Value("#{configProperties['Merchant.MobileMerchantNO']}")
    ...
    @Value("#{configProperties['Merchant.MobileHostSchema']}")
    private String MobileHostSchema;
...
//    RedPacketUtil redPacketUtil;
    ...
    public void BindUnBindCard(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String paramReturnUrl = MobileHostSchema + "/Card/Index";
            String bindUnBindCardNotifyURL = "BizPayment/Mobile/BindCardNotify";
            String BindUnBindCard = serverUrl + "/recharge/mobilebind.jsp";
            ...
            data.put("postUrl", BindUnBindCard);
    ...
    public void LostHangCard(HttpServletRequest request, HttpServletResponse response) {
        try {
            String basePath = HostSchema + request.getContextPath() + "/";
            String paramReturnUrl = MobileHostSchema + "/Card/Index";
            String bindUnBindCardNotifyURL = "BizPayment/Mobile/LostHangNotify";
            String BindUnBindCard = serverUrl + "/recharge/mobilelosthang.do";
            //String paramMerchantNo = request.getParameter("merchantNo").trim();
            String paramCardNo = request.getParameter("cardNo").trim();//0000019900000164
    ...
    public void CardReCharge(HttpServletRequest request, HttpServletResponse response) {
        try {
            String rechargeCardNotifyURL = "BizPayment/Mobile/RechargeCardNotify";
            String basePath = HostSchema + request.getContextPath() + "/";
            String CardReCharge = serverUrl + "/recharge/mplaceorder.do";
            ...
            String ipAddr = getRemoteHost(request);
            String paramReturnUrl = MobileHostSchema + "/Card/Index";//request.getParameter("returnURL").trim();
...
//                    }
    ...
    private void WritePaylog(String ipAddr,String rechargeamt,PAYLOG logType, String cardNo, String orderNo, String orderAmt,String tranTime,String discountAmt,String actualCharge,String tranSerialNo, String member, boolean status, String memo, HttpServletRequest request) {
        ...
        if (user.getPhone()!=null){
            verifyCode = sendCode(user.getPhone());
        }
    ...
    private String sendCode(String phone){
        ...
        String sendMessage = "充值成功,请凭此验证码:"+code+"领取凭据.";
        try{
